...
function ClickUser(x) {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      str += '<div class="img-bottom" style="position:relative;"><img src="./map/'+ doc.data().LoyMapLoyKrathong +'" style="width:100%; height:80vh; border-radius:15px; margin-top:-15px;">';
